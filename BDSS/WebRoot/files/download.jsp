...
<%
	...
	FileOperate fo=new FileOperate(id); 
	String e_path=	fo.saveFile();//保存文件，并返回excel文件路径 
	
	String ly_time = new SimpleDateFormat("yyyyMMddHHmmss").format(Calendar
			.getInstance().getTime());
	String filename=ly_time+".xls";
	System.out.print("---"+filename);
	String filedisplay2 = URLEncoder.encode(filename,"gbk");
